...
echo "&nbsp;&nbsp;<a href='http://".$ro->getMyUrl()."/COCONUT/currentPatient/patientInterface.php?completeName=NA_NA&username=$username&module=$module'><font color=blue size=2>Sign In >></font></a>";
$ro->coconutBoxStop();
