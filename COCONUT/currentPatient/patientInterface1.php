...
window.location="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/currentPatient/patientInterface.php?module=&completeName="+data+"&username=<?php echo $username; ?>"; 
...
<li><a href="http://<?php echo $ro->getMyUrl() ?>/COCONUT/patientProfile/dischargePlan.php?registrationNo=<?php echo $registrationNo ?>" target="patientX">Discharged Plan</a></li>

<li><a href="http://<?php echo $ro->getMyUrl() ?>/COCONUT/patientProfile/medicoLegalList.php?registrationNo=<?php echo $registrationNo ?>" target="patientX">Medico Legal</a></li>
...
<li><a href="../../Forms/AdmissionAndDischargeRecord.php?registrationNo=<?php echo $registrationNo; ?>&username=<?php echo $username; ?>" target="_blank">Admission Discharge Record</a></li>        
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/philhealth/revisedSep2013/cf2.php?registrationNo=<?php echo $registrationNo; ?>&username=<?php echo $username; ?>" target="patientX"><font color="red"></font> CF2 Front <font color=red>2014</font></a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/philhealth/revisedSep2013/cf2back.php?registrationNo=<?php echo $registrationNo; ?>&username=<?php echo $username; ?>" target="patientX"><font color="red"></font> CF2 Back <font color=red>2014</font></a></li>
...
<?php }else {
 ?>
<iframe src="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/patientProfile/patientProfile_handler.php?registrationNo=<?php echo $registrationNo; ?>&username=<?php echo $username; ?>" name="patientX" width="1315" height="560" style="border:hidden;  "></iframe>
<?php } ?>
