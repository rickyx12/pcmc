...
.MyStyle {text-decoration: none;font-family: Arial;font-size: 12px;color: #000000;font-weight: bold;}
.MyStyle2 {text-decoration: none;font-family: Arial;font-size: 12px;color: #0066FF;font-weight: bold;}
...
if( $ro->showPatientHistory_count($_GET['patientSearch'],$_GET['username']) > 10 ) {
...
<tr>
<td bgcolor='#0066FF'>&nbsp;Status&nbsp;</td>
<td bgcolor='#0066FF'>&nbsp;Reg#&nbsp;</td>
<td bgcolor='#0066FF'>&nbsp;Name&nbsp;</td>
<td bgcolor='#0066FF'>&nbsp;Registered&nbsp;</td>
<td bgcolor='#0066FF'>&nbsp;Type&nbsp;</td>
<td bgcolor='#0066FF'>&nbsp;Discharged&nbsp;</td>
<td bgcolor='#0066FF'>&nbsp;&nbsp;</td>
";

//echo "<td bgcolor='#0066FF'>&nbsp;Account Status&nbsp;</td>";

echo "
<tr>";
$ro->showPatientHistory($_GET['patientSearch'],$_GET['username'],"11","1000",$module);
echo "
</tr>
</table>
";
