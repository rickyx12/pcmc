...
<?php
$patientNo = preg_split ("/\_/", $_GET['completeName']);
echo "<br><center><div>";
...
$ro->showPatientHistory($patientNo[1],$_GET['username'],"0","11");
echo "</div>";
echo "</table>";


if( $ro->showPatientHistory_count($patientNo[1],$username) > 10 ) {
echo "<center><a href='patientInterfaceMore.php?username=$username&module=$module&patientSearch=".$patientNo[1]."' target='_blank'><font size=4 color=red>Click to See more Records</font></a></center>";
}
else{}

echo "</center>";

/*if( $ro->showPatientHistory_count($patientNo[1],$_GET['username']) > 10 ) {
echo "
...
<Td><font color='white'>&nbsp;Pat#&nbsp;</font></tD>
...
";
$ro->coconutTableRowStart();
$ro->showPatientHistory($patientNo[1],$_GET['username'],"11","1000");
$ro->coconutTableRowStop();
echo "</table>";
echo "</div>";
