...
echo " <frame src='/COCONUT/Cashier/unPaidPatient.php?month=$month&day=$day&year=$year&fromTime_hour=$fromTime_hour&fromTime_minutes=$fromTime_minutes&fromTime_seconds=$fromTime_seconds&toTime_hour=$toTime_hour&toTime_minutes=$toTime_minutes&toTime_seconds=$toTime_seconds&module=$module&username=$username&branch=$branch&type=All'  scrolling=yes style='overflow-x:hidden;' frameborder=1 framespacing=1 name='patientList' />";
echo "<frame src='/COCONUT/Cashier/cashierPage.php'  scrolling=yes frameborder=1 framespacing=1 name='patientCharges' />";
echo "</frameset>";
