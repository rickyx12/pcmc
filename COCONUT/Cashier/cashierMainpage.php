 ...
 <div class="menu">
        <ul>
            <li>
		      ...
		      <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Cashier/force/cashierShift.php?module=<?php echo $module; ?>&username=<?php echo $username; ?>" target="departmentX" >Force Diagnostics</a></li>
                    ...
                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/patientProfile/Payments/manualPayment_select.php?username=<?php echo $username; ?>" target="departmentX">Manual Payments</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/Registration/newRecord.php?username=<?php echo $username ?>" target="_blank">Unknown Patient</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/opdRegistration1.php?username=<?php echo $username ?>" target="departmentX">OPD Registration</a></li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/Department/cashCollection/selectOption.php?username=<?php echo $username; ?>" target="departmentX">Collection Per Dept (IPD)</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Cashier/departmentOPD.php?username=<?php echo $username; ?>" target="departmentX">Collection Per Dept (OPD)</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Doctor/doctorModule/doctorPF_shift.php?username=<?php echo $username; ?>&module=<?php echo $module; ?>" target="departmentX">IPD Doctor's PF</a></li>
...
<iframe src="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Cashier/cashierPage.php?" width="991" height="540" style="overflow-x:hidden; " name="departmentX" border=1 frameborder=no></iframe>
