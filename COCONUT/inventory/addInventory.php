...
echo "<br><center><div style='border:1px solid #000000; width:500px; height:550px; border-color:black black black black;'>";
...
echo "<td><input type=text class='txtBox' name='generic'></td>";
echo "</tr>";
echo "<tr>";
echo "<tr>";
...
$ro->coconutHidden("suppliesUNITCOST","");
echo "</form>";
echo "</body>";
