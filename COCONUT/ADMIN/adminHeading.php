...
<li>
  <a href="#">PCMC Reports<span class="arrow"></a>             
  <ul>

    <li><a href="../../Forms/Codes201607/UserLogLockUnlockReportSD.php?username=<?php echo $username; ?>" target="departmentX">User Log(Lock/Unlock)</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Company/AgingOfAccountsMenu.php?username=<?php echo $username; ?>&module=<?php echo $module; ?>" target="departmentX">Payments Aging</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Reports/Census/selectShift.php?username=<?php echo $username; ?>&switch=2" target="departmentX">Summary Examination Census</a></li>
<li><a href="../../Forms/LaboratoryRequestSummarySD.php?username=<?php echo $username; ?>&switch=2" target="departmentX">Laboratory Census</a></li>
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/room/roomCensusDate.php" target="departmentX">Room Census</a></li>
...
echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/billing/billingStation.php?username=$username&module=ADMIN&branch=Pagadian&floor=2ND FLOOR OLD BUILDING' target='departmentX'>2ND FLOOR OLD BUILDING</a></li>";

echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/billing/billingStation.php?username=$username&module=ADMIN&branch=Pagadian&floor=3RD FLOOR OLD BUILDING' target='departmentX'>3RD FLOOR OLD BUILDING</a></li>";

echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/billing/billingStation.php?username=$username&module=ADMIN&branch=Pagadian&floor=4TH FLOOR OLD BUILDING' target='departmentX'>4TH FLOOR OLD BUILDING</a></li>";

echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/billing/billingStation.php?username=$username&module=ADMIN&branch=Pagadian&floor=5TH FLOOR OLD BUILDING' target='departmentX'>5TH FLOOR OLD BUILDING</a></li>";

echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/billing/billingStation.php?username=$username&module=ADMIN&branch=Pagadian&floor=3RD FLOOR NEW BUILDING(MAB)' target='departmentX'>3RD FLOOR NEW BUILDING(MAB)</a></li>";

echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/billing/billingStation.php?username=$username&module=ADMIN&branch=Pagadian&floor=4TH FLOOR NEW BUILDING(MAB)' target='departmentX'>4TH FLOOR NEW BUILDING(MAB)</a></li>";
...
<li><a href="../../Forms/DeletedChargesReportSD.php?username=<?php echo $username; ?>&show=All&desc=" target='departmentX'>Deletd Charges Report</a></li>
