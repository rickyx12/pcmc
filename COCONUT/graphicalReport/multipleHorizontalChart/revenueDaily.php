...
$year = $_GET['year'];
	...
	$serie2 = new XYDataSet();
  	$serie2->addPoint(new Point("$month 31 ",($ro->getPxRevenueDaily_ipd($month,"31",$year) / 1000) ));
  	$serie2->addPoint(new Point("$month 30 ",($ro->getPxRevenueDaily_ipd($month,"30",$year) / 1000) ));
  	$serie2->addPoint(new Point("$month 29 ",($ro->getPxRevenueDaily_ipd($month,"29",$year) / 1000) ));
  	$serie2->addPoint(new Point("$month 28 ",($ro->getPxRevenueDaily_ipd($month,"28",$year) / 1000) )); 	
  	$serie2->addPoint(new Point("$month 27 ",($ro->getPxRevenueDaily_ipd($month,"27",$year) / 1000) ));
  	$serie2->addPoint(new Point("$month 26 ",($ro->getPxRevenueDaily_ipd($month,"26",$year) / 1000) ));
  	$serie2->addPoint(new Point("$month 25 ",($ro->getPxRevenueDaily_ipd($month,"25",$year) / 1000) ));
  	$serie2->addPoint(new Point("$month 24 ",($ro->getPxRevenueDaily_ipd($month,"24",$year) / 1000) ));        		
...
$d2=$year."-".$month."-01";
	...
	$chart->setTitle("Revenue for ".date("F d, Y",strtotime($d2))."");
