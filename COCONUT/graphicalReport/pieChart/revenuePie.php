...
$d2=$fromYear."-".$fromMonth."-".$fromDay;
	...
	$chart->setTitle("Collection Report For ".date("F d, Y",strtotime($d2))."");
...
$dataSet1->addPoint(new Point("TOTAL (".number_format($total,2).")",""));
	...
	$chart1->setTitle("OPD Breakdown Collection Report For ".date("F d, Y",strtotime($d2))."");
