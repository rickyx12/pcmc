...
<div id='printData'>
//<a href="#" onClick="printF('printData')" style="text-decoration:none; color:black;"></a>
...
<table width='630' border='0' align='center' cellpadding='0' cellspacing='0'>
  <tr>
    <td width='465' rowspan='4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='http://".$ro->getMyUrl()."/COCONUT/myImages/header1.jpg' width='521' height='100'/></td>
      </tr>
...
echo "<tr>";
echo "<td><font size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Not Valid without seal</font></td>";
echo "</tr>";
