...
$allowedBalance = ( $ro->getTotal("cashUnpaid","MEDICINE",$registrationNo) + $ro->getTotal("cashUnpaid","SUPPLIES",$registrationNo) );

//if( $ro->selectNow("registrationDetails","LimitCASH","registrationNo",$registrationNo) > $ro->may_naibayad_naba_ang_patient($registrationNo) ) { //enable charges
//if( $ro->selectNow("registrationDetails","LimitCASH","registrationNo",$registrationNo) > $allowedBalance ) {
...
echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/Results/clinicalChemistry/view_labTest_done.php?registrationNo=$registrationNo&username=$username' target='rightFrame'><font size=2>Results</font></a></li>";

echo "<li><a href='http://192.168.1.22/REPORTVIEW/LoadPatientReports.aspx?itemNo=1&registrationNo=".$ro->getRegistrationDetails_registrationNo()."' target='rightFrame'><font size=2>LIS Results</font></a></li>";
...
echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/patientProfile/noDialysis.php?status=PAID&username=$username&registrationNo=".$ro->getRegistrationDetails_registrationNo()."' target='rightFrame'><font size=2>noDialysis</font></a></li>";
