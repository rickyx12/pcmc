...
if( $ro->selectNow("registeredUser","module","username",$username) == "PHILHEALTH" ) {
...
echo "<td><input type=text name='mothersName' autocomplete='off' class='txtBox' value='".$ro->selectNow("patientRecordAddInfo","mothersName","patientNo",$ro->getRegistrationDetails_patientNo())."'></td>";
echo "</tr>";

echo "<tr>";
echo "<td>Father's Name&nbsp;</td>";
echo "<td><input type=text name='fathersName' autocomplete='off' class='txtBox' value='".$ro->selectNow("patientRecordAddInfo","fathersName","patientNo",$ro->getRegistrationDetails_patientNo())."'></td>";
echo "</tr>";


echo "<tr>";
echo "<td>Spouse Name&nbsp;</td>";
echo "<td><input type=text name='spouseName' autocomplete='off' class='txtBox' value='".$ro->selectNow("patientRecordAddInfo","spouseName","patientNo",$ro->getRegistrationDetails_patientNo())."'></td>";
echo "</tr>";

echo "<tr>";
echo "<td>Informant&nbsp;</td>";
echo "<td><input type=text name='informant' autocomplete='off' class='txtBox' value='".$ro->selectNow("registrationDetailsAddInfo","informant","registrationNo",$registrationNo)."'></td>";
echo "</tr>";

echo "<tr>";
echo "<td>Relationship&nbsp;</td>";
echo "<td><input type=text name='relationship' autocomplete='off' class='txtBox' value='".$ro->selectNow("registrationDetailsAddInfo","relationtopatient","registrationNo",$registrationNo)."'></td>";
echo "</tr>";
...
$savedisc=$ro->selectNow("registrationDetails","discount","registrationNo",$registrationNo);
echo $ro->coconutHidden("discount","$savedisc");
$savedisc=$ro->selectNow("registrationDetails","discountType","registrationNo",$registrationNo);
echo $ro->coconutHidden("discount","$savedisc");
}
