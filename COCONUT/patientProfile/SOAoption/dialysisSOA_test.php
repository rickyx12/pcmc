...
$actual+=$ro->getTotal_hdu("total","OTHERS",$registrationNo);
$phic+=$ro->getTotal_hdu("phic","OTHERS",$registrationNo);
$company+=$ro->getTotal_hdu("company","OTHERS",$registrationNo);
$excess+=$ro->getTotal_hdu("cashUnpaid","OTHERS",$registrationNo);
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("total","OTHERS",$registrationNo)."</font></tD>";
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("phic","OTHERS",$registrationNo)."</font></tD>";
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("company","OTHERS",$registrationNo)."</font></tD>";
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("cashUnpaid","OTHERS",$registrationNo)."</font></tD>";
echo "</tr>";
...
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("total","EXCESS-TIME",$registrationNo)."</font></tD>";
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("phic","EXCESS-TIME",$registrationNo)."</font></tD>";
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("company","EXCESS-TIME",$registrationNo)."</font></tD>";
echo "<td>&nbsp;<font size=2>".$ro->getTotal_hdu("cashPaid","EXCESS-TIME",$registrationNo)."</font></tD>";
echo "</tr>";
...
$totalPd1 = ( $ro->getTotal_hdu("cashPaid","DIALYSIS",$registrationNo) + $ro->getTotal_hdu("cashPaid","MEDICINE",$registrationNo) + $ro->getTotal_hdu("cashPaid","LABORATORY",$registrationNo) + $ro->getTotal_hdu("cashPaid","OXYGEN",$registrationNo) + $ro->getTotal_hdu("cashPaid","ADDITIONAL-CHARGES",$registrationNo) + $ro->getTotal_hdu("cashPaid","HPS",$registrationNo)+ $ro->getTotal_hdu("cashPaid","EMERGENCY-FEE",$registrationNo) + $ro->getTotal_hdu("cashPaid","EXCESS-TIME",$registrationNo)+ $ro->getDoctorsFee_atteding_cashUnpaid() + $ro->getDoctorsFee_anesth_cashUnpaid() );
