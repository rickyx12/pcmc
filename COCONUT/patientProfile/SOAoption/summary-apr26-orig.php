...
echo "<td>&nbsp;"; echo number_format(abs( $soa->medicine_excess()),2); echo"&nbsp;</td>";
...
echo "<tr>";
echo "<td>&nbsp;Oxygen OR used&nbsp;</td>";
if( $ro->getTotal("total","O2",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","O2",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","O2",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","O2",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","O2",$registrationNo),2); echo"&nbsp;</td>";
...
if( $ro->checkIfTitleExist($registrationNo,"DEFIBRILLATOR") > 0  ) {
echo "<tr>";
echo "<td>&nbsp;DEFIBRILLATOR&nbsp;</td>";
if( $ro->getTotal("total","DEFIBRILLATOR",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","DEFIBRILLATOR",$registrationNo),2); echo"&nbsp;</td>";
$gt+=$ro->getTotal("total","DEFIBRILLATOR",$registrationNo);
$hospitalBill_gt += $ro->getTotal("total","DEFIBRILLATOR",$registrationNo);
}else {
echo "<Td>&nbsp;</td>";
}
   ...
   ///////////////// DEFIBRILLATOR
if( $ro->getTotal("phic","DEFIBRILLATOR",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","DEFIBRILLATOR",$registrationNo),2); echo"&nbsp;</td>";
$phicz+=$ro->getTotal("phic","DEFIBRILLATOR",$registrationNo);
$hospitalBill_phic += $ro->getTotal("phic","DEFIBRILLATOR",$registrationNo);
}else {
echo "<Td>&nbsp;</td>";
}
    ...
    ///////////// DEFIBRILLATOR
if( $ro->getTotal("company","DEFIBRILLATOR",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","DEFIBRILLATOR",$registrationNo),2); echo"&nbsp;</td>";

$company+=$ro->getTotal("company","DEFIBRILLATOR",$registrationNo);
$hospitalBill_company += $ro->getTotal("company","DEFIBRILLATOR",$registrationNo);
}else {
echo "<tD>&nbsp;</tD>";
}
...
if( $ro->getTotal("cashUnpaid","DEFIBRILLATOR",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","DEFIBRILLATOR",$registrationNo),2); echo"&nbsp;</td>";
$cashz += $ro->getTotal("cashUnpaid","DEFIBRILLATOR",$registrationNo);
$hospitalBill_cash += $ro->getTotal("cashUnpaid","DEFIBRILLATOR",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
echo "</tr>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","C-Arm",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","C-Arm",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","C-Arm",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","C-Arm",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<tr>";
echo "<td>&nbsp;Ambulance Fee&nbsp;</td>";
if( $ro->getTotal("total","AMBULANCE",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","AMBULANCE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","AMBULANCE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","AMBULANCE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","AMBULANCE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","DIALYSISCHARGE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","DIALYSISCHARGE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","DIALYSISCHARGE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","DIALYSISCHARGE",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<tr>";
echo "<td>&nbsp;Incubator&nbsp;</td>";
if( $ro->getTotal("total","INCUBATOR",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","INCUBATOR",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","INCUBATOR",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","INCUBATOR",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","INCUBATOR",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","BCG",$registrationNo),2); echo"&nbsp;</td>";
$gt+=$ro->getTotal("total","INCUBATOR",$registrationNo);
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","BCG",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","BCG",$registrationNo),2); echo"&nbsp;</td>";
...
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","BCG",$registrationNo),2); echo"&nbsp;</td>";
