...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","Room And Board",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<tD>&nbsp;<input type='text' class='editable'></tD>";
}
...
echo "<td>&nbsp;<input type=text class='editable' value='".number_format($ro->getTotal("cashUnpaid","Room And Board",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","MEDICINE",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","MEDICINE",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","MEDICINE",$registrationNo),2)."'>&nbsp;</td>";
$company+=$ro->getTotal("company","MEDICINE",$registrationNo);
$hospitalBill_company += $ro->getTotal("company","MEDICINE",$registrationNo);
}else {
echo "<Td>&nbsp;<input type='text' value='' class='editable'></tD>";
}
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","MEDICINE",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","SUPPLIES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","SUPPLIES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","SUPPLIES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","SUPPLIES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","LABORATORY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","LABORATORY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","LABORATORY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","LABORATORY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","RADIOLOGY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","RADIOLOGY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","RADIOLOGY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","RADIOLOGY",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","ECG",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","ECG",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","ECG",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","ECG",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","NURSING-CHARGES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","NURSING-CHARGES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","NURSING-CHARGES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","NURSING-CHARGES",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","MISCELLANEOUS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","MISCELLANEOUS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","MISCELLANEOUS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","MISCELLANEOUS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","OR/DR/ER Fee",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='"; echo number_format($ro->getTotal("phic","OR/DR/ER Fee",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","OR/DR/ER Fee",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","OR/DR/ER Fee",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","REHAB",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","REHAB",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","REHAB",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","REHAB",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","OXYGEN",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","OXYGEN",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","OXYGEN",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","OXYGEN",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","NBS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","NBS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","NBS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","NBS",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","CARDIAC",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","CARDIAC",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","CARDIAC",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","CARDIAC",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_gt,2)."'></tD>";
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_phic,2)."'></tD>";
echo "<tD>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_company,2)."'></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_cash,2)."'></tD>";
echo "</tr>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("total","OVERTIME",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("phic","OVERTIME",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("company","OVERTIME",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($ro->getTotal("cashUnpaid","OVERTIME",$registrationNo),2)."'>&nbsp;</td>";
...
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_gt + $pf_gt,2)."'>&nbsp;</tD>";
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_phic + $pf_phic,2)."'>&nbsp;</tD>";

echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_company + $pf_company ,2)."'>&nbsp;</tD>";
//echo "<td>&nbsp;<b>".number_format($hospitalBill_phic + $pf_phic,2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format($hospitalBill_cash + $pf_cash ,2)."'>&nbsp;</tD>";
echo "</tr>";
}
...
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;</tD>";
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format(($gross - $ro->getRegistrationDetails_discount()  ) + $pf_cash ,2)."'>&nbsp;</tD>";
echo "</tr>";
}
...
if( $remainBalance > 0 ) {
echo "<td>&nbsp;<input type='text' class='editable' value='".number_format( $remainBalance ,2)."'>&nbsp;</tD>";
}else {
echo "<td>&nbsp;<input type='text' class='editable' value='0.00'>&nbsp;</tD>";
}
