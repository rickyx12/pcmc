...
/************2D ECHO************************/
if( $ro->checkIfTitleExist($registrationNo,"2D_ECHO") > 0 ) {
echo "<tr>";
echo "<td>&nbsp;2D ECHO&nbsp;</td>";
if( $ro->getTotal("total","2D_ECHO",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("total","2D_ECHO",$registrationNo),2); echo"&nbsp;</td>";
$gt+=$ro->getTotal("total","2D_ECHO",$registrationNo);
$hospitalBill_gt += $ro->getTotal("total","2D_ECHO",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
   ...
   ///////////////// PHIC 2D ECHO
if( $ro->getTotal("phic","2D_ECHO",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("phic","2D_ECHO",$registrationNo),2); echo"&nbsp;</td>";
$phicz+=$ro->getTotal("phic","2D_ECHO",$registrationNo);
$hospitalBill_phic += $ro->getTotal("phic","2D_ECHO",$registrationNo);
}else {
echo "<td>&nbsp;</td>";
}
  ...
  //////// COMPANY 2D ECHO
if( $ro->getTotal("company","2D_ECHO",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("company","2D_ECHO",$registrationNo),2); echo"&nbsp;</td>";
$company+=$ro->getTotal("company","2D_ECHO",$registrationNo);
$hospitalBill_company += $ro->getTotal("company","2D_ECHO",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
...
//CASH ECG
if( $ro->getTotal("cashUnpaid","2D_ECHO",$registrationNo) > 0 ) {
echo "<td>&nbsp;"; echo number_format($ro->getTotal("cashUnpaid","2D_ECHO",$registrationNo),2); echo"&nbsp;</td>";
$cashz += $ro->getTotal("cashUnpaid","2D_ECHO",$registrationNo);
$hospitalBill_cash += $ro->getTotal("cashUnpaid","2D_ECHO",$registrationNo);
}else {
echo "<td>&nbsp;</tD>";
}
echo "</tr>";
