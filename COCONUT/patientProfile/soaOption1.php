...
echo "<form method='get' action='http://".$ro->getMyUrl()."/COCONUT/patientProfile/SOAoption/groupTheSame.php'>";
echo "<input type=hidden name='registrationNo' value='$registrationNo' >";
echo "<input type=hidden name='username' value='$username'>";
...
echo "<form method='get' action='http://".$ro->getMyUrl()."/COCONUT/patientProfile/SOAoption/dialysisSOA_testpaid.php'>";
echo "<input type=hidden name='registrationNo' value='$registrationNo' >";
echo "<input type=hidden name='username' value='$username'>";
echo "<input type=submit value='S.O.A (Dialysis Paid)' class='button'>";
echo "</form>";
...
echo "<form method='get' target='_blank' action='http://".$ro->getMyUrl()."/COCONUT/patientProfile/SOAoption/summary-apr26.php'>";
echo "<input type=hidden name='registrationNo' value='$registrationNo' >";
echo "<input type=hidden name='username' value='$username'>";
echo "<input type=hidden name='show' value='All'>";
