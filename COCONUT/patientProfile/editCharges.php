...
echo "<a href='http://".$ro->getMyUrl()."/COCONUT/patientProfile/charity/editCharges.php?itemNo=$itemNo&username=$username&show=$show&desc=$desc' style='text-decoration:none;'><font color=red>Charity</font></a>";
echo "<Br>";
echo "<a href='http://".$ro->getMyUrl()."/COCONUT/patientProfile/hmoPrice.php?itemNo=$itemNo&username=$username' style='text-decoration:none;'><font color=blue>HMO Price</font></a>";
