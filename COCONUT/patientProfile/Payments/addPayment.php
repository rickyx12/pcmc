...
echo "<option value='CUT-OFF HOSPITAL BILL'>CUT-OFF HOSPITAL BILL</option>";
...
echo "<td><input type=text name='amountPaid' value='".round( ($ro->hospitalBill_pf($registrationNo,"H")) )."' class='shortField'></tD>";
echo "</tr>";

echo "<tr>";
echo "<td><font class='labelz'>PF</font></tD>";
echo "<td><input type=text name='pf' value='".round($ro->getPF_notAdmitting($registrationNo))."' class='shortField'></tD>";
echo "</tr>";


echo "<tr>";
echo "<td><font class='labelz'>Admitting</font></tD>";
echo "<td><input type=text name='admitting' value='".round($ro->getPF_Admitting($registrationNo))."' class='shortField'></tD>";
echo "</tr>";
