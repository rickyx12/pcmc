...
$ro->coconutFormStart("post","http://".$ro->getMyUrl()."/COCONUT/patientProfile/Payments/phicPayment1.php");
...
echo "<td>Doctor</td>";
echo "<td>";
$ro->coconutTextBox_readonly("doctor",$ro->selectNow("patientCharges","description","itemNo",$itemNo));
echo "</td>";
echo "</tr>";
