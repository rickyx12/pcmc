...
echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/Results/clinicalChemistry/view_labTest_done.php?registrationNo=$registrationNo&username=$username' target='rightFrame'><font size=2>Lab Results</font></a></li>";
