...
echo "<br>";
echo "<center><b>(<font size=3>$fromYear-$fromMonth-$fromDay to $toYear-$toMonth-$toDay</font>)</b></center>";

$ro->getPhilHeealthReceivables($fromMonth,$fromDay,$fromYear,$toMonth,$toDay,$toYear,$type)
//$ro->getPhilHeealthReceivables($fromMonth,$fromDay,$fromYear,$toMonth,$toDay,$toYear,"DIALYSIS")
