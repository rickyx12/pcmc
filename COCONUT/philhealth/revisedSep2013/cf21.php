...
<table width='860' border='0' align='center' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td><div align='center'><span class='style5'>(Claim Form 2)<br />
...
<table width='860' border='0' align='center' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td><font size=1>This form together with other supporting documents should be filed within sixty (60) calendar days from date of discharge. </font>   </td>
  </tr>
  <tr>
...
<tr>
<td class='style1'><span style='margin:0 0 0 147px;'> c.Date Discharged: <input type='text' class='panz' value='$monthOut_output1' ><input type='text' class='panz1' value='$monthOut_output2' >-<input type='text' class='panz' value='$dayOut_output1' ><input type='text' class='panz1' value='$dayOut_output2' >-<input type='text' class='panz' value='$yearOut_output1' ><input type='text' class='panz1' value='$yearOut_output2' ><input type='text' class='panz1' value='$yearOut_output3' ><input type='text' class='panz1' value='$yearOut_output4' > &nbsp;&nbsp;&nbsp;&nbsp;d.Time Discharged: <input type='text' class='panz' value='$timeOut_hour2_12hrs'><input type='text' class='panz1' value='$timeOut_hour1_12hrs' >:<input type='text' class='panz' value='$timeOut_minutes1' ><input type='text' class='panz1' value='$timeOut_minutes2' >";
...
echo "<br><center><table style='width:860px;' border=0 >";
echo "<tr>";
echo "<td><font size=2><b>5.Type of Accomodation</b> &nbsp;&nbsp;&nbsp; <input type='checkbox'><font size=2>Private</font> &nbsp;&nbsp; <input type='checkbox'><font size=2>Non-Private(Charity/Service)</font> </td>";
echo "</tr>";
echo "</table></center>";
...
echo "<center><table style='width:860px; border-right:0px; border-left:0px; border-bottom:0px; border-top:0px solid #000;' >";
echo "<Tr>";
echo "<Td> <font size=2><i>c.For MCP Package(enumerate four dates[mm-dd-yyyy] of pre-natal check ups)</i></font></td>";
echo "</tr>";
echo "</table>";
...
echo "<center><table style='width:860px; border-right:0px; border-left:0px; border-bottom:0px; border-top:0px solid #000;' >";
echo "<Tr>";
echo "<Td> <font size=2 style='letter-spacing:0em;'><i>e.For Animal Bite Package (write the dates [<i>mm-dd-yyyy</i>] when the following does of vaccine  were given</i></font> 
</td>";
echo "</tr>";
echo "<tr>";
