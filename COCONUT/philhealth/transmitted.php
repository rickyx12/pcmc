...
echo "<center><font size=5>PAGADIAN CITY MEDICAL CENTER</font></center>";
echo "<center><font size=2>Tertiary and Philhealth Accredited Hospital</font></center>";
echo "<center><font size=2>Cabrera Street,Pagadian City</font></center>";
...
echo "<br><center><font size=3 color=black><u><a href='/COCONUT/philhealth/transmittedEdit.php?fromMonth=$fromMonth&fromDay=$fromDay&fromYear=$fromYear&toMonth=$toMonth&toDay=$toDay&toYear=$toYear&package=$package&type=$type'><font color=black>TRANSMITTAL LETTER</font></a></u></font></center>";
echo "<br>";
...
$ro->getTransmitted($discharged,$discharged1,$package,$type,"off");
...
echo "<Td>Printed Name&nbsp;<u>Shirly U. Entes</u><Br>Designation&nbsp;&nbsp;<u>Medicare Clerk</u></td>";
echo "</tr>";
echo "</table>";
