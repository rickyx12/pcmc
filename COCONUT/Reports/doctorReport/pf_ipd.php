...
echo "<br><font size=2>( $fromDate_year-$fromDate_month-$fromDate_day to $toDate_year-$toDate_month-$toDate_day )</font><br>";
$ro->doctorPF_ipd($fromDate_month,$fromDate_day,$fromDate_year,$toDate_month,$toDate_day,$toDate_year,$show);
