...
$supPrice =  $ro->selectNow("inventory","unitcost","inventoryCode",$chargesCode); 

$companyPrice = ($supPrice * 0.25 ) + $supPrice;
...
$ro->addCharges_cash($status,$registrationNo,$chargesCode,$description,$companyPrice,$discount,$totalCompanyPrice,"0","0",$totalCompanyPrice,$ro->getSynapseTime(),date("Y-m-d"),$username,$service,$title,$paidVia,$cashPaid,$batchNo,$quantity,$inventoryFrom,$ro->getRegistrationDetails_branch(),$room);
}
