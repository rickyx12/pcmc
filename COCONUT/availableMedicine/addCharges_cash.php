...
$totalPrice = ($medsPrice[1] * $quantity);
...
$ro->addCharges_cash_autoDispense($status,$registrationNo,$chargesCode,$description,$medsPrice[1],$discount,$totalPrice,$totalPrice,"0","0",$ro->getSynapseTime(),date("Y-m-d"),$username,$service,$title,$paidVia,$cashPaid,$batchNo,$quantity,$inventoryFrom,$ro->getRegistrationDetails_branch(),$room,"dispensedBy_".$username,$ro->getSynapseTime());
}else {
$ro->addCharges_cash($status,$registrationNo,$chargesCode,$description,$medsPrice[1],$discount,$totalPrice,$totalPrice,"0","0",$ro->getSynapseTime(),date("Y-m-d"),$username,$service,$title,$paidVia,$cashPaid,$batchNo,$quantity,$inventoryFrom,$ro->getRegistrationDetails_branch(),$room);
}
