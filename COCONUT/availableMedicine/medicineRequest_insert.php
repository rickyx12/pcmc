...
//$ro->requestNow($inventoryCode,$description,$quantity,$requestTo_department,$branch,$requestingDepartment,$ro->getUserBranch_username($username,$requestingDepartment),$username,date("Y-m-d"),date("H:i:s"),$status);

$ro->requestNow($inventoryCode,$description,$quantity,$requestTo_department,$branch,$requestingDepartment,"Pagadian",$username,date("Y-m-d"),date("H:i:s"),$status,$requestNo);
