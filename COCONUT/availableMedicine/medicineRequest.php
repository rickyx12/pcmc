...
xmlhttp.open("GET","medicineRequest1.php?requestingDepartment="+document.medicineSearch.requestingDepartment.value+"&inventoryType="+document.medicineSearch.inventoryType.value+"&branch="+document.medicineSearch.branch.value+"&username="+document.medicineSearch.username.value+"&description="+document.medicineSearch.searchMedicine.value+"&requestNo="+document.medicineSearch.requestNo.value,true);
xmlhttp.send();
}
...
echo "<input type=hidden name='requestNo' value='$requestNo'>";
echo "</form>";
