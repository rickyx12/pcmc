...
echo "<form method='get' action='roomCensus.php'>";
echo "<center><br><br><Br><font size=3 color=red>Room Census</font><br><div style='border:1px solid #000000; width:500px; height:100px; border-color:black black black black;'>";
...
echo "<option vlaue='".date("d")."'>".date("d")."</option>";
for($x=1;$x<32;$x++) {
if($x<10) {
echo "<option value='0$x'>0$x</option>";
}else {
