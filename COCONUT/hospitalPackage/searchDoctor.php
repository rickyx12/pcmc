...
xmlhttp.open("GET","searchDoctor1.php?packageName="+document.addCharge.packageName.value+"&desc="+document.addCharge.availableCharges.value+"&packagePrice="+document.addCharge.packagePrice.value,true);
xmlhttp.send();
}
...
echo "<a href='http://".$ro->getMyUrl()."/COCONUT/hospitalPackage/searchCharges.php?packageName=$packageName&packagePrice=$packagePrice' style='text-decoration:none;'><font color=red>Services</font></a>";

echo "<a href='http://".$ro->getMyUrl()."/COCONUT/hospitalPackage/searchInventory.php?packageName=$packageName&packagePrice=$packagePrice' style='text-decoration:none;'><br><font color=red>Medicine / Supplies</font></a>";
