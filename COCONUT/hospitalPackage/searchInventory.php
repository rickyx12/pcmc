...
xmlhttp.open("GET","searchInventory1.php?packageName="+document.addCharge.packageName.value+"&desc="+document.addCharge.availableCharges.value+"&packagePrice="+document.addCharge.packagePrice.value,true);
xmlhttp.send();
}
