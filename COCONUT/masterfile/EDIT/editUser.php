...
$show = $_GET['show'];
$proficiencyNo = $_GET['proficiencyNo'];
...
echo "<br><center><div style='border:1px solid #000000; width:500px; height:230px; border-color:black black black black;'>";
...
<Tr>
<td>Prof No#:</td>
<td><input type=text name='proficiencyNo' class='txtBox' value='$proficiencyNo'></td>
</tr>
