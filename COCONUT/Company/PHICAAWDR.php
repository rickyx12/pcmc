...
if($daysaged<30){$a=$totcomfmt; $b=''; $c=''; $d=''; $e=''; $grandhba+=$totcom; $grandhbb+=0; $grandhbc+=0; $grandhbd+=0; $grandhbe+=0;}
else if(($daysaged>=30)&&($daysaged<60)){$a=''; $b=$totcomfmt; $c=''; $d=''; $e=''; $grandhba+=0; $grandhbb+=$totcom; $grandhbc+=0; $grandhbd+=0; $grandhbe+=0;}
else if(($daysaged>=60)&&($daysaged<90)){ $a=''; $b=''; $c=$totcomfmt; $d=''; $e=''; $grandhba+=0; $grandhbb+=0; $grandhbc+=$totcom; $grandhbd+=0; $grandhbe+=0; }
else if(($daysaged>=90)&&($daysaged<120)){$a=''; $b=''; $c=''; $d=$totcomfmt; $e=''; $grandhba+=0; $grandhbb+=0; $grandhbc+=0; $grandhbd+=$totcom; $grandhbe+=0;  }
else if($daysaged>=120){$a=''; $b=''; $c=''; $d=''; $e=$totcomfmt; $grandhba+=0; $grandhbb+=0; $grandhbc+=0; $grandhbd+=0; $grandhbe+=$totcom; }
