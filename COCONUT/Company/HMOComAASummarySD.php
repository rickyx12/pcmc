...
<div align='center'>
  <table width='700' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000'>
    <tr>
      <form id='Select' name='Select' method='get' action='HMOComAASummary.php'>
        <td bgcolor='#FFCC33'><div align='center'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
          <tr>
...
echo "
          <tr>
            <td align='center' valign='middle'><div align='center' class='style1'>
              From <select name='fmonth' class='textfield01'>
...
echo "
              To <select name='tmonth' class='textfield01'>
