...
<br><br>
---------------------------- PRICE's -------------------------------------<Br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=1>OPD:</font>&nbsp;<input type=text name='opdprice' value=' 0.00' class='prices'>
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=1>WARD:</font>&nbsp;<input type=text name='wardprice' value=' 0.00' class='prices'><br>
<input type=hidden name='category' value='$module'>
<input type=hidden name='username' value='$username'>
&nbsp;&nbsp;&nbsp;<font size=1>SOLO WARD:</font>&nbsp;<input type=text name='solowardprice' value=' 0.00' class='prices'><br>

&nbsp;<font size=1>SEMI PRIVATE:</font>&nbsp;<input type=text name='semiprivateprice' value=' 0.00' class='prices'><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=1>PRIVATE:</font>&nbsp;<input type=text name='privateprice' value=' 0.00' class='prices'><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=1>HMO:</font>&nbsp;<input type=text name='hmo' value=' 0.00' class='prices'>
