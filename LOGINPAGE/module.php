...
echo "<iframe src='http://".$ro->getMyUrl()."/COCONUT/Homepage/homepage.php?' width='840' height='555'  name='welcome' border=1 frameborder=no></iframe>";
...
echo "<form method='get' action='loginpage.php'>
<input type=hidden name='module' value='KEEPER'>
<input type=submit value='KEEPER'>
</form>";
