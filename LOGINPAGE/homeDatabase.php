...
if($module == "DOCTOR") {
$result = mysql_query("SELECT username,password,module FROM Doctors where username = '".mysql_real_escape_string($username)."' and password='".mysql_real_escape_string($password)."' and module = '".mysql_real_escape_string($module)."' ");
}else {
$result = mysql_query("SELECT username,password,module FROM registeredUser where username = '".mysql_real_escape_string($username)."' and password='".mysql_real_escape_string($password)."' and module = '".mysql_real_escape_string($module)."' ");
}
