...
$ro->addCharges_cash_registration("UNPAID",$registrationNo,$ro->selectNow("Doctors","doctorCode","Name",$admittingDoctor),$admittingDoctor,"300/300",0,300,300,0,0,$serverTime,$dateRegistered,$ro->getUserRegistered(),"ADMITTING","PROFESSIONAL FEE","Cash",0,"",1,"",$ro->getUserBranch($password),"");
}else if( $attendingDoctor != "attending" && $admittingDoctor != "admitting" ) {
$ro->addCharges_cash_registration("UNPAID",$registrationNo,$ro->selectNow("Doctors","doctorCode","Name",$admittingDoctor),$admittingDoctor,"300/300",0,300,300,0,0,$serverTime,$dateRegistered,$ro->getUserRegistered(),"ADMITTING","PROFESSIONAL FEE","Cash",0,"",1,"",$ro->getUserBranch($password),"");
