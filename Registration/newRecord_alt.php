...
echo "	<br>";
echo "<input type=text name='lastname' class='myInformation' id='firstname' placeholder='LAST NAME' />";

echo "";
echo "<input type=text name='firstname' class='myInformation' id='firstname' placeholder='FIRST NAME' />";


echo "";
echo "<input type=text name='middlename' class='myInformation' id='middlename' placeholder='MIDDLE NAME' />";

echo "";
echo "<input type=text name='patientContact' class='myInformation' id='patientContact' placeholder='Contact No#' />";
...
echo "&nbsp;&nbsp;<input type=text name='birthYear' class='birthYear' id='birthyear' placeholder='Year' />";
...
echo "<br><textarea class='patientAddress' id='patientAddress' name='Address' placeholder='ADDRESS'></textarea>";
