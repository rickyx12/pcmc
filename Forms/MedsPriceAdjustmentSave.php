...
$cmopd=mysql_real_escape_string($_GET['mopd']);
$cmopdhmo=mysql_real_escape_string($_GET['mopdhmo']);
$cmipd=mysql_real_escape_string($_GET['mipd']);
$cmbaseprice=mysql_real_escape_string($_GET['mbaseprice']);
  ...
  <tr>
    <td width='49%' valign='top'><table border='0' width='100%' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td height='25' colspan='3'><div align='left' class='arial15blue'>Saving changes...</div></td>
          </tr>
        </table></div></td>
      </tr>
";

mysql_query("UPDATE priceadjustments SET mopd='".($cmopd/100)."', mopdhmo='".($cmopdhmo/100)."', mipd='".($cmipd/100)."', mbaseprice='$cmbaseprice', dateadded='".date("YmdHis")."', loginuser='$username' WHERE refno='1'");
          ...
          <tr>
            ...
            <td><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
              <tr>
                ...
                <input name='username' type='hidden' value='$username' />
                <input name='switch' type='hidden' value='off' />
                <td><input name='switch' type='submit' class='$supc1' value='   Off   ' /></td>
                </form>
                <form name='On' method='get' action='SupPASwitch.php'>
                <input name='username' type='hidden' value='$username' />
                <input name='switch' type='hidden' value='on' />
                <td><input name='switch' type='submit' class='$supc2' value='   On    ' /></td>
                </form>
              </tr>
            </table></div></td>
          </tr>
...
echo "<META HTTP-EQUIV='Refresh'CONTENT='0;URL=MedsSupPriceAdjustmentSettings.php?username=$username'>";
?>
</body>
</html>
