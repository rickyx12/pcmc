...
<div align='center'>
  <table width='300' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000'>
    <form id='View' name='Create' method='get' action='LaboratoryRequestSummary.php'>
    <input type='hidden' name='username' value='$username' />
    <tr>
      <td><table width='300' border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td colspan='3' height='30'><div class='style1' align='center'>&nbsp;Select Date</div></td>
        </tr>
        <tr>
...
echo "
        ...
        <tr>
          <td colspan='3' height='35'><div class='style1' align='center'>
