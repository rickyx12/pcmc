  ...
  <tr>
    <td width='49%' valign='top'><table border='0' width='100%' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td height='25' colspan='3'><div align='left' class='arial15blue'>Switching $switch...</div></td>
          </tr>
        </table></div></td>
      </tr>
";

mysql_query("UPDATE priceadjustments SET mstatus='$switch', dateadded='".date("YmdHis")."', loginuser='$username' WHERE refno='1'");
