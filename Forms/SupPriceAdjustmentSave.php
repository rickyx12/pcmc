...
$csopd=mysql_real_escape_string($_GET['sopd']);
$csopdhmo=mysql_real_escape_string($_GET['sopdhmo']);
$csipd=mysql_real_escape_string($_GET['sipd']);
$csbaseprice=mysql_real_escape_string($_GET['sbaseprice']);
...
mysql_query("UPDATE priceadjustments SET sopd='".($csopd/100)."', sopdhmo='".($csopdhmo/100)."', sipd='".($csipd/100)."', sbaseprice='$csbaseprice', dateadded='".date("YmdHis")."', loginuser='$username' WHERE refno='1'");
