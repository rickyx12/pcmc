...
if($type=='Payments'){$types1="selected='selected'";$types2="";}else if($type=='Charges'){$types1="";$types2="selected='selected'";}
...
<table border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    ...
    <td bgcolor='#FFFFFF'>
      <select name='type' class='textfield2'>
        <option $types1>Payments</option>
        <option $types2>Charges</option>
      </select>
    </td>
    <td bgcolor='#FFFFFF'>&nbsp;</td>
...
$a++;
$patientNo=$cuz->selectNow("registrationDetails","patientNo","registrationNo",$afetch['registrationNo']);
...
echo "
  <tr>
    ...
    <td height='20' class='table1Bottom1Left'><div align='left' class='style5'>&nbsp;".strtoupper($completeName)."&nbsp;</div></td>
...
<table width='100%' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    ...
    <td height='20' bgcolor='#0066FF' class='table2Top2Bottom'><div align='center' class='style4'>&nbsp;Patient's Name&nbsp;</div></td>
    <td height='20' bgcolor='#0066FF' class='table2Top2Bottom'><div align='center' class='style4'>&nbsp;Date-Time Paid&nbsp;</div></td>
    <td height='20' bgcolor='#0066FF' class='table2Top2Bottom'><div align='center' class='style4'>&nbsp;Description&nbsp;</div></td>
    <td height='20' bgcolor='#0066FF' class='table2Top2Bottom'><div align='center' class='style4'>&nbsp;Amount&nbsp;</div></td>
    <td height='20' bgcolor='#0066FF' class='table2Top2Bottom'><div align='center' class='style4'>&nbsp;Paid Via&nbsp;</div></td>
    <td height='20' bgcolor='#0066FF' class='table2Top2Bottom'><div align='center' class='style4'>&nbsp;Log In User&nbsp;</div></td>
  </tr>
...
$a=0;
if($search!=''){
$asql=mysql_query("SELECT registrationNo, cashPaid, datePaid, timePaid, paidBy, description, paidVia FROM patientCharges WHERE orNo='$search'");
$acount=mysql_num_rows($asql);
...
echo "
  <tr>
    ...
    <td height='20' class='table1Bottom1Left'><div align='left' class='style5'>&nbsp;".strtoupper($completeName)."&nbsp;</div></td>
    <td height='20' class='table1Bottom1Left'><div align='center' class='style5'>&nbsp;".$afetch['datePaid']."-".$afetch['timePaid']."&nbsp;</div></td>
    <td height='20' class='table1Bottom1Left'><div align='left' class='style5'>&nbsp;".strtoupper($afetch['description'])."&nbsp;</div></td>
    <td height='20' class='table1Bottom1Left'><div align='right' class='style5'>&nbsp;".number_format($afetch['cashPaid'],2)."&nbsp;</div></td>
    <td height='20' class='table1Bottom1Left1Right'><div align='center' class='style5'>&nbsp;".strtoupper($afetch['paidVia'])."&nbsp;</div></td>
    <td height='20' class='table1Bottom1Left1Right'><div align='center' class='style5'>&nbsp;".strtoupper($afetch['paidBy'])."&nbsp;</div></td>
  </tr>
";
}
