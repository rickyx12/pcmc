...
<table width='100%' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    <td width='10'></td>
    <td><div align='left' class='arial14bluebold'>Removing item...</div></td>
  </tr>
</table>
";

mysql_query("UPDATE `inventorypaexception` SET status='Deleted', dateadded='".date("YmdHis")."', addedby='$username' WHERE refno='$refno'");
