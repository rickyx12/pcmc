...
<table width='100%' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    <td width='10'></td>
    <td><div align='left' class='arial14bluebold'>Add Item Excemted from Price Adjustments</div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width='10'></td>
    <td>
      <input type='text' name='availableCharges' id='charges' class='textfield13' onfocus='SetMsg(this, true);' onblur='SetMsg(this,false);' onkeyup='showResult();' value='' autocomplete='off' placeholder=' Input Search Here' />
  ...
  <tr>
    <td width='5'></td>
    <td><div id='livesearch' class='arial12blackbold'></div></td>
  </tr>
</table>
";
?>
