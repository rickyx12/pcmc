...
<title>User Log In Report</title>
...
<table border='0' width='100%' cellspacing='0' cellpadding='0'>
  ...
  <tr>
    <td class='table2Bottom'><div align='center' class='CourierNew12BlackBold'>User Log In Report</div></td>
  </tr>
  <tr>
    <td height='10'></td>
  </tr>
...
if($registrationNo==""){
$ulpsql=mysql_query("SELECT username, registrationNo, datetime FROM userLogPatient WHERE datetime BETWEEN '$fdate' AND '$tdate' ORDER BY datetime");
}
else{
$ulpsql=mysql_query("SELECT username, registrationNo, datetime FROM userLogPatient WHERE registrationNo='$registrationNo' AND (datetime BETWEEN '$fdate' AND '$tdate') ORDER BY datetime");
}
...
echo "
      <tr>
        <td><div align='left' class='Arial13Black'>&nbsp;".strtoupper($cuz->selectNow("registeredUser","completeName","username",$ulpfetch['username']))."&nbsp;</div></td>
        ...
        <td><div align='center' class='Arial13Black'>&nbsp;".date("M d, Y H:i:s",strtotime($ulpfetch['datetime']))."&nbsp;</div></td>
      </tr>
";
}
