...
mysql_query("UPDATE registrationDetailsAddInfo SET informant='".strtoupper($informant)."',  informantaddress='".strtoupper($informantaddress)."', relationtopatient='".strtoupper($relationtopatient)."', informantcontactno='$informantcontactno', dateAdded='$dateAdded', addedBy='$username' WHERE registrationNo='$registrationNo'");
...
";
echo "<META HTTP-EQUIV='Refresh'CONTENT='1;URL=RegMoreDetails.php?username=$username&registrationNo=$registrationNo'>";
?>
</body>
</html>
