...
-->
  ...
  <table width='100%' border='0' cellspacing='0' cellpadding='0'>
    ...
    <tr>
      <td colspan='14' height='50' valign='top' bgcolor='#FFFFFF'><div align='center'><span class='style1'>Daily Admission Patient List</span><br /><span class='style4'>$fdatefmt</span></di></td>
    </tr>
    <tr>
...
$presdate=date("Y-m-d");
$num=0;
$asql=mysql_query("SELECT pr.lastName, pr.firstName, pr.middleName, pr.Birthdate, pr.Gender, pr.Address, pr.phic, rd.registrationNo, rd.initialDiagnosis, rd.IxDx, rd.finalDiagnosis, rd.dateRegistered, rd.dateUnregistered, rd.timeRegistered, rd.timeUnregistered, rd.infectionControl FROM patientRecord pr, registrationDetails rd WHERE rd.patientNo=pr.patientNo AND rd.dateRegistered='$fdate' AND type='IPD' ORDER BY rd.dateRegistered, rd.timeRegistered");
