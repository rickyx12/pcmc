...
<br />
<br />
<div align='center' class='style2'>Cancel Deleted.</div>
";

$cuz->editNow("patientCharges","itemNo",$itemNo,"deleteRemarks","");
$cuz->editNow("patientCharges","itemNo",$itemNo,"pendingDelete","");
